module polymedia_circles::circle
{
    ...
    /// <circle cx="139" cy="402" r="204" fill="rgb(131,162,224)" stroke="black" stroke-width="8" />
    public(friend) fun to_svg(self: &Circle): vector<u8> {
        ...
        vector::append(&mut svg, b"%22%20stroke%3D%22black%22%20stroke-width%3D%228%22%20%2F%3E"); // " stroke="black" stroke-width="8" />
        return svg
    }
