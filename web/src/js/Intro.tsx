    ...
    <div id='intro'>
        ...
        <div id='faq'>
            ...
            <div className='question'>
                ...
                <p>From a certain point of view, it is an NFT collection.</p>
            ...
            <div className='question'>
                <h2>What are the project goals?</h2>
                    ...
                    <p>3. The artwork should display natively in Sui wallets and explorers. No additional code or libraries are allowed. Therefore, the artwork must be compatible with the Sui <Link text='Display Standard' href='https://docs.sui.io/build/sui-object-display' /> so it shows everywhere out of the box.</p>

                    <p>4. The artwork should be dynamic. Owners will have the ability to modify it according to certain rules. This introduces a new element of creative unpredictability: not only are the initial artworks generated algorithmically, but subsequent versions will depend on the choices of their owners. More details on this later.</p>
            </div>

            <div className='question'>
                <h2>How does it work?</h2>
                <p>Using an algorithm and randomness, an <Link text='SVG' href='https://developer.mozilla.org/en-US/docs/Web/SVG' /> is built on-chain when someone sends a mint transaction. The SVG is then formatted as a <Link text='data URL' href='https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/Data_URLs' /> in the artwork's <Link text='Display' href='https://docs.sui.io/build/sui-object-display' />, so that it renders an image in wallets and explorers.</p>
            </div>
            ...
            <div className='question'>
                ...
                <p>
                    The exact initial mint price and growth factor are yet to be decided. But as an example, if the initial price is 1 SUI and the price increments by 0.1% on each mint, then:
                </p>
                <p>
            ...
            <div className='question'>
                ...
                <p>While technically there is no supply limit, in practice the increasing minting price (see previous question) will limit supply to most likely just a few hundred artworks.</p>
            </div>

            <div className='question'>
                <h2>Is there a whitelist?</h2>
                <p>There can be a whitelist if there is interest. If you are a Polymedia supporter and want to be included, please reach out on Twitter. If I (@juzybits) follow you, or we've interacted in the past, there's a good chance you are eligible for the whitelist.</p>
            </div>
            ...
            <div className='question'>
                ...
                <p>Any NFT venues that want to enable trading of Polymedia Circles are free to do so, as I will not be placing any constraints on the collection.</p>
            </div>
