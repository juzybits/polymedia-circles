        ...
        <div id='faq-faq'>
            ...
            <div className='question'>
                <h2>What are the project goals?</h2>
                    <p>1. The artwork should be created fully on-chain, on the fly within a mint transaction. No preprocessing is allowed. Therefore, the code must be efficient in order to reduce Sui computation fees.</p>
                    ...
                    <p>3. The artwork should display natively in Sui wallets and explorers. No additional code or libraries are allowed. Therefore, the artwork must be compatible with the Sui <A text='Display Standard' href='https://docs.sui.io/build/sui-object-display' /> so that it works everywhere out of the box.</p>
            ...
            <div className='question'>
                ...
                <p>So far I have implemented two dynamic features, but many more are possible (suggestions are welcome). These two simple features introduce an element of human selection on top of the algorithmic randomness, which can lead to more aesthetic and interesting outcomes:</p>
                <p>1) Recycling artwork. Holders can destroy existing artworks in order to mint new ones at a big discount. Because some    aspects of Polymedia Circles are random, some pieces will be more desirable than others. If a minter is not happy with the artwork they got, they can recycle it into a new one for just 10% of the full price.</p>
                <p>2) Blending artwork. Holders can combine two artworks by picking which of their circles they'd like to swap. This means holders can refine their own artworks according to their personal taste, while simultaneously shaping and curating the entire Polymedia Circles collection in the process.</p>
            </div>

            <div className='question'>
                <h2>How does it work?</h2>
                <p>When someone sends a mint transaction, an <A text='SVG' href='https://developer.mozilla.org/en-US/docs/Web/SVG' /> is built on-chain using the Circles algorithm sprinkled with randomness. The SVG is then formatted as a <A text='data URL' href='https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/Data_URLs' /> in the artwork's <A text='Display' href='https://docs.sui.io/build/sui-object-display' />, so that it renders an image in wallets and explorers.</p>
                ...
                <p>Artworks are Sui objects. An artwork object includes its SVG representation, which allows it to be displayed as an image, as well as its component properties, such as the size and color of each circle. This is what enables the dynamic nature of Polymedia Circles.</p>
            </div>
            ...
            <div className='question'>
                ...
                <p>From a copyright perspective, you are free to use your artwork however you like, even commercially. The exact license is yet to be decided, but I am leaning towards <A text='CC BY' href='https://creativecommons.org/licenses/by/4.0/'/>.</p>
            ...
            <div className='question'>
                ...
                <p>There can be if there is interest. If you are a Polymedia supporter and want to be included, please reach out. If I follow you on Twitter, or we've had a positive interaction in the past, there's a good chance you are eligible for the whitelist.</p>
            </div>
            ...
            {/* <div className='question'>
                ...
                <p>- As long as I own the <A text='Publisher' href='https://examples.sui.io/basics/publisher.html' /> object, I can make changes to the artwork <A text='Display' href='https://examples.sui.io/basics/display.html' /> which can break or alter how everyone's artwork objects gets displayed in wallets.</p>
