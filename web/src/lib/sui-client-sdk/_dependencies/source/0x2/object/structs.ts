...
export class DynamicFields<K extends TypeArgument> {
  ...
  static reified<K extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        DynamicFields.fromFields(K, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        DynamicFields.fromFieldsWithTypes(K, item),
      ...
      fetch: async (client: SuiClient, id: string) =>
        DynamicFields.fetch(client, K, id),
  ...
  static async fetch<K extends Reified<TypeArgument, any>>(
    ...
    if (
      ...
      !isDynamicFields(res.data.bcs.type)
    ) {
...
export class Ownership {
  ...
  static reified(): OwnershipReified {
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Ownership.fromFieldsWithTypes(item),
